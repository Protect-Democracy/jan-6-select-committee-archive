 ...
 */
export default async function mediaCenterWitnessMaterials(page) {
  // Selector is not that specific
  const mainSelector = ".field-type-text-with-summary .field-item";
  ...
  listItems.forEach((li) => {
    ...
    links.forEach((l) => {
      ...
      // Only get PDfs
      if (materialFileName.match(/\.pdf$/i)) {
        materials.push({
